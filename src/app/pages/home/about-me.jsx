				...
				<div className="container">
					...
					<div className="row">
						<div className="col-xs-12 col-lg-10 col-lg-offset-1 col-xl-8 col-xl-offset-2">
							<p>Hi there! I'm Agustin Vijoditz, a Denver based full stack web developer with more than {this.props.expYears} years of experience. I started coding in school when I was 12 years old, in January 2005 I got my first job as a full-time web developer, and since then I've been completely involved this amazing never-ending process of learning new languages, libraries, tools and methodologies everyday.</p>

							<p>During my career as a web developer, I have had the opportunity to work with a variety of companies in different industries, allowing me to become very versatile in my work. These projects have also allowed me to become familiar with the companies ́ workings and therefore create applications that facilitate and accelerate their processes.</p>
